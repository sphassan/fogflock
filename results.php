...
<html lang="en">
    ...
    <body>
      <nav class="navbar navbar-inverse">
        ...
        <div style="height:600px" class=".hidden-sm-down">
        ...
        <script src = "scripts/main_improved.js"></script>
      </div>
        </br>
          <?php
          $dummy = json_decode(file_get_contents("http://fogflock.com:8080/hello?text=".urlencode($_GET['users']), false));
          $result = json_decode(file_get_contents("http://fogflock.com/data.json"));
    ...
    <footer><center><font color="white"><p>Made by: Rico Balakit and Sean Hassan</p></font></center></footer>
  </body>
</html>
